---
title: "La boxe fait-elle maigrir ? Calories, résultats, silhouette"
description: "La boxe fait-elle maigrir ? Calories, métabolisme, délai de résultat et pourquoi elle n'épaissit pas la silhouette. Séance d'essai offerte à Genève."
pubDate: 2026-06-02
author: "Nicolas de Boccard"
image: "/blog/boxe-perte-de-poids-femme-geneve.webp"
tags: ["boxe perte de poids femme", "boxe fait maigrir", "boxe femme silhouette", "boxe métabolisme", "boxe Genève", "cours de boxe femme"]
category: "guide"
draft: false
---
...
<Tldr>
- Une heure de boxe brûle environ 500 à 600 calories, comparable à la course à pied, avec un travail technique en plus (source : Harvard Health)
- L'EPOC (effet afterburn) prolonge la dépense énergétique plusieurs heures après la séance : vous continuez à brûler après l'effort
- La boxe affine la silhouette sans prendre de masse : le taux de testostérone chez la femme ne permet pas d'hypertrophie marquée sans programme dédié
- Les résultats sur la composition corporelle sont généralement visibles après 6 à 12 semaines à raison de deux séances par semaine
</Tldr>
...
Cet article démonte les chiffres réels, explique ce qui se passe dans votre corps après une séance intense, démystifie le mythe de la silhouette "massive", et vous donne un délai honnête avant de voir un résultat. Pour [le guide complet de la boxe pour femme à Genève](/blog/boxe-femme-geneve-guide-complet), l'article hub du sous-cluster vous donnera la vue d'ensemble. Ici on se concentre sur la mécanique de **la boxe et la perte de poids chez la femme**.
...
{/* TODO:image infographic - Comparatif depense calorique par heure : boxe, course, velo, natation - barres horizontales minimalistes fond sombre, highlight or sur boxe - brief: src/content/blog/.briefs/boxe-perte-de-poids-femme-geneve.md#image-2 */}
...
Pour une explication plus détaillée des mécanismes, [la boxe ne vous rendra pas massive : l'explication détaillée](/blog/boxe-femme-massive-epaules-geneve) traite ce sujet spécifiquement.

![Silhouette tonifiée et affinée d'une femme qui pratique la boxe, sans prise de masse, garde de boxe et gants dans un studio à Genève](/images/blog/boxe-perte-de-poids-femme-geneve-3.webp)
...
Pour le détail du rythme optimal selon les objectifs, [combien de séances de boxe par semaine pour progresser](/blog/combien-seances-boxe-par-semaine-debutant) développe ce point.
...
[Découvrir la boxe pour femme chez Bis Repetita](/services/boxe-femme). Premier cours offert, sans engagement.

![Nicolas de Boccard, coach de boxe à Genève, accompagne les débutantes, portrait buste au studio Bis Repetita La Voie-Creuse](/images/blog/boxe-perte-de-poids-femme-geneve-4.webp)

Pour la suite : [le déroulé d'un premier cours de boxe](/blog/premier-cours-de-boxe-preparation) vous explique à quoi vous attendre concrètement.
...
Si vous êtes à Genève et que vous voulez tester, la première séance est offerte à La Voie-Creuse 16. Venez en tenue de sport, on s'occupe du reste.

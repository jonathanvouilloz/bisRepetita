---
title: "La boxe est-elle dangereuse ? Les vrais chiffres"
description: "La boxe loisir affiche moins de blessures que le football. Le risque réel, et comment débuter sans prendre de coups, à Genève. Séance d'essai offerte."
pubDate: 2026-06-25
author: "Nicolas de Boccard"
image: "/blog/la-boxe-est-elle-dangereuse-blessures-loisir.webp"
tags: ["la boxe est-elle dangereuse", "boxe blessures", "boxe sans combat", "boxe loisir débutant", "boxe risque cerveau", "danger de la boxe"]
category: "guide"
draft: false
---
...
<Tldr>
- La **boxe loisir encadrée** affiche environ 0,6 à 2 blessures pour 1 000 heures d'entraînement, contre ~8 au football. C'est l'un des sports les moins accidentogènes rapporté au temps de pratique.
- Les dangers réels concernent la **boxe de combat** (sparring, compétition, coups répétés à la tête), pas la boxe technique sans opposition qu'un débutant pratique.
- Chez **Bis Repetita**, vos premières séances se font sur sac, pattes d'ours et shadow boxing : vous ne recevez aucun coup à la tête.
- Le vrai facteur de risque, c'est l'absence d'encadrement et de progressivité, pas la boxe en elle-même.
</Tldr>
...
Dans cet article : les chiffres réels de blessures comparés à d'autres sports, la différence entre combat et loisir, les idées reçues sur le cerveau et le nez, et comment se déroule concrètement une première séance chez [Bis Repetita, studio de coaching à Genève](/cours-de-boxe-geneve). Si vous souhaitez le panorama complet avant de vous lancer, consultez [le guide pour débuter la boxe à Genève](/cours-de-boxe-geneve).
...
{/* TODO:image infographic : Comparatif blessures pour 1000h : boxe (~0,6-2), football (~8), rugby (>8) — brief: src/content/blog/.briefs/la-boxe-est-elle-dangereuse-blessures-loisir.md#image-2 */}
...
![Coach guidant un débutant aux pattes d'ours, boxe loisir sans combat à Genève](/images/blog/la-boxe-est-elle-dangereuse-blessures-loisir-3.webp)
...
Pour le détail complet minute par minute, lisez [le déroulé d'un premier cours de boxe](/blog/premier-cours-de-boxe-preparation). Pour comprendre le cadre spécifique aux femmes, la page [la boxe pour femme chez Bis Repetita](/services/boxe-femme) présente l'environnement du studio.

Pour un encadrement individualisé, les [formats de coaching privé](/services/coaching-prive) permettent une attention totale sur votre progression : Solo (120 CHF), Duo (140 CHF) ou Trio (160 CHF).
...
**Sur la durée**
- Progressivité entre les séances : lisez [combien de séances de boxe par semaine pour bien récupérer](/blog/combien-seances-boxe-par-semaine-debutant) pour calibrer votre rythme sans vous surmener
- Antécédents cardiaques ou articulaires : un avis médical avant de débuter est recommandé. Consultez [à quel âge commencer la boxe](/blog/a-quel-age-commencer-la-boxe) pour les considérations liées à votre profil.
...
![Nicolas de Boccard, coach de boxe licencié SwissBoxing à Genève](/images/blog/la-boxe-est-elle-dangereuse-blessures-loisir-4.webp)
...
<ArticleCta
  title="Testez sans risque"
  description="Première séance d'essai gratuite, équipement fourni, aucun sparring imposé. Studio à Genève centre."
